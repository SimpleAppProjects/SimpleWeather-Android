...
/* HERE Autocomplete */
fun createLocationModel(location: SuggestionsItem, weatherAPI: String): LocationQueryViewModel {
...
/* HERE Geocoder */
fun createLocationModel(location: ResultItem, weatherAPI: String): LocationQueryViewModel {
    return LocationQueryViewModel().apply {
        ...
        if (!town.isNullOrBlank() && !region.isNullOrBlank() &&
            ...
            if (town.isNullOrBlank() || region.isNullOrBlank()) {
                if (!location.location.address.label.isNullOrBlank()) {
