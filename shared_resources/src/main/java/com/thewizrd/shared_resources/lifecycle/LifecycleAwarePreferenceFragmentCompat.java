...
public abstract class LifecycleAwarePreferenceFragmentCompat extends PreferenceFragmentCompat {
    ...
    public final boolean isViewAlive() {
        ...
        if (isFragmentCreated) {
            try {
                return getViewLifecycleOwner().getLifecycle().getCurrentState().isAtLeast(Lifecycle.State.CREATED);
