...
class AmbeePollenProvider : PollenProviderInterface {
    companion object {
        private const val QUERY_URL = "https://api.ambeedata.com/latest/pollen/by-lat-lng?lat=%s&lng=%s"
    }
                ...
                try {
                    ...
                    val request = Request.Builder()
                            .cacheControl(CacheControl.Builder()
                                    ...
                                    .build())
                            .url(String.format(Locale.ROOT, QUERY_URL, df.format(location.latitude), df.format(location.longitude)))
