...
class SolCalcAstroProvider : AstroDataProviderInterface, AstroDataProviderDateInterface {
    ...
    override suspend fun getAstronomyData(location: LocationData, date: ZonedDateTime): Astronomy {
        ...
        astronomy.sunrise = astroData.sunriseUTC!!.plusSeconds(location.tzOffset.totalSeconds.toLong())
