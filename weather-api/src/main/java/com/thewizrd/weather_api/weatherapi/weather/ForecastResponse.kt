...
data class Current(
    ...
    @field:Json(name = "pollen")
    var pollen: Pollen? = null,
)
...
data class Pollen(
    ...
    @field:Json(name = "Alder")
    var alder: Double? = null,

    @field:Json(name = "Birch")
    var birch: Double? = null,

    @field:Json(name = "Mugwort")
    var mugwort: Double? = null,

    @field:Json(name = "Oak")
    var oak: Double? = null,

    @field:Json(name = "Grass")
    var grass: Double? = null,

    @field:Json(name = "Hazel")
    var hazel: Double? = null,

    @field:Json(name = "Ragweed")
    var ragweed: Double? = null
)
