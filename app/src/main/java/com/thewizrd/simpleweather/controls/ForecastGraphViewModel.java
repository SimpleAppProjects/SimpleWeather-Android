        ...
        if (!ObjectsCompat.equals(this.locationKey, location.getQuery())) {
            ...
            mMainHandler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    currentForecastsData = Transformations.map(Settings.getWeatherDAO().getLiveForecastData(locationKey),
                    ...
                    currentHrForecastsData = Transformations.map(Settings.getWeatherDAO().getLiveHourlyForecastsByQueryOrderByDateByLimit(locationKey, 24),
