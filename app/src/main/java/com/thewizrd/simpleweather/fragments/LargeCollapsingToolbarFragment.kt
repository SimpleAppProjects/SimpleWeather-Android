...
import com.thewizrd.simpleweather.databinding.FragmentCollapsingtoolbarLargeLayoutBinding

abstract class LargeCollapsingToolbarFragment : WindowColorFragment() {
    // Views
    private lateinit var binding: FragmentCollapsingtoolbarLargeLayoutBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentCollapsingtoolbarLargeLayoutBinding.inflate(inflater, container, false)
