    ...
    public void onMessageReceived(final MessageEvent messageEvent) {
        switch (messageEvent.getPath()) {
            ...
            case WearableHelper.SettingsPath:
                WearableWorker.enqueueAction(this, WearableWorker.ACTION_SENDSETTINGSUPDATE, true);
                break;
            case WearableHelper.LocationPath:
                WearableWorker.enqueueAction(this, WearableWorker.ACTION_SENDLOCATIONUPDATE, true);
                break;
            case WearableHelper.WeatherPath:
                WearableWorker.enqueueAction(this, WearableWorker.ACTION_SENDWEATHERUPDATE, true);
                break;
