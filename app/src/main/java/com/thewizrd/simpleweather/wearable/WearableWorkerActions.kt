...
object WearableWorkerActions {
    ...
    const val ACTION_SENDPARTIALWEATHERUPDATE =
        "SimpleWeather.Droid.action.SEND_PARTIAL_WEATHER_UPDATE"
    const val ACTION_SENDSETUPSTATUS = "SimpleWeather.Droid.action.SEND_SETUP_STATUS"
}