    ...
    public static class WeatherWidgetPreferenceFragment extends PreferenceFragmentCompat implements OnBackPressedFragmentListener, SnackbarManagerInterface {
        ...
        private RecyclerOnClickListenerInterface recyclerClickListener = new RecyclerOnClickListenerInterface() {
            ...
            public void onClick(final View view, final int position) {
                ...
                }).addOnSuccessListener(new OnSuccessListener<LocationQueryViewModel>() {
                    @Override
                    public void onSuccess(LocationQueryViewModel result) {
                        mSearchFragmentAdapter.getDataset().clear();
        ...
        private void prepareWidget() {
            ...
            if (locationPref.getValue() != null) {
                ...
                mActivity.sendBroadcast(new Intent(WeatherWidgetProvider.ACTION_SHOWREFRESH)
