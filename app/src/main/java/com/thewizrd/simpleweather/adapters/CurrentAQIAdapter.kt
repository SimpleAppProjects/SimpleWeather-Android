...
import com.thewizrd.simpleweather.databinding.LayoutAqiCurrentItemBinding

class CurrentAQIAdapter : RecyclerView.Adapter<CurrentAQIAdapter.ViewHolder>() {
    private var aqiModel: AirQualityViewModel? = null

    inner class ViewHolder(private val binding: LayoutAqiCurrentItemBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(LayoutAqiCurrentItemBinding.inflate(LayoutInflater.from(parent.context)).apply {
